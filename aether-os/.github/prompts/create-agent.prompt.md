---
description: "Create a new Aether OS agent type. Use when: new agent, create agent, add agent preset, build agent"
---

Create a new Aether OS agent preset called `${agentName}`.
