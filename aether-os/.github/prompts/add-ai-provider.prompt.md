---
description: "Add a new AI provider to Aether OS AIAdapter. Use when: new AI provider, add model, integrate LLM, add provider"
---

Add a new AI provider called `${providerName}` to the Aether OS `AIAdapter`.
